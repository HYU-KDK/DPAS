...
class DPASInterface(DPCAlphaInterface):
    ...
    def _register_local_hook(self):
        ...
        try:
            ...
            print(f"[DPAS] Registered visual hook on ViT block {self.feature_layer}.")
        except Exception as e:
            self._hook_handle = None
            print(f"[DPAS] Warning: Could not register visual hook: {e}")
